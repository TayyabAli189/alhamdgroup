            ...
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-md-12 text-center">
                        <h2 class="slide-title" data-animation-in="slideInLeft">You're Most Welcome At</h2>
                        <h3 class="slide-sub-title" data-animation-in="slideInRight">AL HAMAD TELECOM SERVICES</h3>
                        <p data-animation-in="slideInLeft" data-duration-in="1.2">
                            <a href="" class="slider btn btn-primary">Our Services</a>
                            <a href="{{url('contactus')}}" class="slider btn btn-primary border">Contact Now</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center h-100">
                    <div class="col-md-12">
                        ...
                        <div data-animation-in="slideInLeft">
                            <a href="{{url('contactus')}}" class="slider btn btn-primary" aria-label="contact-with-us">Get Free Quote</a>
                            <a href="{{url('about')}}" class="slider btn btn-primary border" aria-label="learn-more-about-us">Learn more</a>
                        </div>
                    </div>
                </div>
            </div>
